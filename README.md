...
本项目对应截图中的**蕴瑜课堂（YUNYU ONLINE COURSES）**平台，面向广东工业大学课程站点 `courses.gdut.edu.cn`。它是基于 Playwright 的课程播放守护脚本，可用于自动播放/续播视频课程。请仅在获得课程平台和授课方许可的情况下使用。

## 对应平台

- 平台名称：蕴瑜课堂（YUNYU ONLINE COURSES）
- 平台地址：<https://courses.gdut.edu.cn/>
- 本项目仅适用于上述蕴瑜课堂课程页面，不适用于智慧树、微助教或其他在线课程平台。
